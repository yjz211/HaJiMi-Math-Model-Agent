...
function registerTaskTools(
  ...
  pi.registerTool({
    ...
    description:'Strict: follow figures → writing → review → ready without skipping; writing freezes figures, review freezes the paper. Reopen figures or writing at any time with a factual note to supply missing evidence, formulas or figures. repairPaths can include new/missing figures; omit to reopen the captured set. Do not wait for a failed audit to repair. Validate delivery in review, then mark ready before completing the milestone. Evidence/experiment/freeze repair tools remain available in stage 8. Lean: activity labels with output checks; ready follows milestone completion.',
