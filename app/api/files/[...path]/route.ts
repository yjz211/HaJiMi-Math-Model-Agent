...
function rawContentType(filePath: string): string {
  return getImageMime(filePath) || getAudioMime(filePath) || ({
    ".pdf": "application/pdf",
...
export async function GET(
  ...
  try {
    ...
    if (type === "raw") {
      ...
      return streamFile(realPath, stat, rawContentType(realPath), request.headers.get("range"));
    }
