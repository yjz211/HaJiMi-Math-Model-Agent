...
export const ChatInput = forwardRef<ChatInputHandle, Props>(function ChatInput({
  ...
  useEffect(() => {
    const handlePointerDown = (e: MouseEvent) => {
      if (secondaryControlsRef.current && !secondaryControlsRef.current.contains(e.target as Node)) setSecondaryControlsOpen(false);
    };
        ...
        <div style={{ marginTop: 8, display: "flex", alignItems: "center", gap: 6, minHeight: 32 }}>
          ...
          <div style={{ flex: "0 0 auto", display: "flex", alignItems: "center", gap: 2 }}>
            <button
              ...
              disabled={uploading}
              title={t("hajimi.upload")}
              aria-label={t("hajimi.upload")}
              style={{
                flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center",
                height: "var(--control-height)", padding: "0 8px",
            ...
            >
              ...
              <span className="ml-1 whitespace-nowrap text-[12px]">{t(uploading ? "hajimi.uploading" : "hajimi.upload")}</span>
            </button>
